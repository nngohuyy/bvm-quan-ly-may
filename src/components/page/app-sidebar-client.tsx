...
import { signOutUser } from "@/app/(auth)/action"
...
export function AppSidebarClient({user } : {user: UserData}) {
  return (
    <Sidebar className="overflow-hidden">
      ...
      <SidebarFooter className="px-1 py-4 sm:px-2">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton onClick={signOutUser} className="hover:cursor-pointer">
              <span>
